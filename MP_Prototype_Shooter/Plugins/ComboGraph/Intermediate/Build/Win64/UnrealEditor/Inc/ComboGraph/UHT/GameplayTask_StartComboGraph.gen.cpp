...
void UGameplayTask_StartComboGraph::FComboGraphTaskEventDelegate_DelegateWrapper(const FMulticastScriptDelegate& ComboGraphTaskEventDelegate, FGameplayTag EventTag, FGameplayEventData EventData)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_ComboGraph_Source_ComboGraph_Public_Abilities_Tasks_GameplayTask_StartComboGraph_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_ComboGraph_Source_ComboGraph_Public_Abilities_Tasks_GameplayTask_StartComboGraph_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_ComboGraph_Source_ComboGraph_Public_Abilities_Tasks_GameplayTask_StartComboGraph_h_746609506(TEXT("/Script/ComboGraph"),
		Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_ComboGraph_Source_ComboGraph_Public_Abilities_Tasks_GameplayTask_StartComboGraph_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_ComboGraph_Source_ComboGraph_Public_Abilities_Tasks_GameplayTask_StartComboGraph_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
