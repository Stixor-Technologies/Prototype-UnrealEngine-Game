...
template<> GASCOMPANIONEDITOR_API UScriptStruct* StaticStruct<FGSCGameplayAbilityCreationData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGSCGameplayAbilityCreationMenu, UGSCGameplayAbilityCreationMenu::StaticClass, TEXT("UGSCGameplayAbilityCreationMenu"), &Z_Registration_Info_UClass_UGSCGameplayAbilityCreationMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGSCGameplayAbilityCreationMenu), 1086923073U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_3376537478(TEXT("/Script/GASCompanionEditor"),
		Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayAbilityCreationMenu_h_Statics::ScriptStructInfo),
		nullptr, 0);
