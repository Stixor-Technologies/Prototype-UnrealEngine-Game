...
template<> GASCOMPANION_API UScriptStruct* StaticStruct<FGSCGameFeatureGameplayEffectMapping>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo[] = {
		{ FGSCGameFeatureAbilityMapping::StaticStruct, Z_Construct_UScriptStruct_FGSCGameFeatureAbilityMapping_Statics::NewStructOps, TEXT("GSCGameFeatureAbilityMapping"), &Z_Registration_Info_UScriptStruct_GSCGameFeatureAbilityMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGSCGameFeatureAbilityMapping), 3276323548U) },
		...
		{ FGSCGameFeatureGameplayEffectMapping::StaticStruct, Z_Construct_UScriptStruct_FGSCGameFeatureGameplayEffectMapping_Statics::NewStructOps, TEXT("GSCGameFeatureGameplayEffectMapping"), &Z_Registration_Info_UScriptStruct_GSCGameFeatureGameplayEffectMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGSCGameFeatureGameplayEffectMapping), 4121826287U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_4267457207(TEXT("/Script/GASCompanion"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_wajee_OneDrive_Documents_Unreal_Projects_TPS_Prototype_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
