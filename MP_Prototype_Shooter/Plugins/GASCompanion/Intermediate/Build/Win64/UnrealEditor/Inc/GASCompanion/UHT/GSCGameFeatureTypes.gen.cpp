...
template<> GASCOMPANION_API UScriptStruct* StaticStruct<FGSCGameFeatureGameplayEffectMapping>()
{
	...
	struct Z_CompiledInDeferFile_FID_MP_Prototype_Shooter_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MP_Prototype_Shooter_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MP_Prototype_Shooter_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_4267457207(TEXT("/Script/GASCompanion"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MP_Prototype_Shooter_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MP_Prototype_Shooter_Plugins_GASCompanion_Source_GASCompanion_Public_GameFeatures_GSCGameFeatureTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
